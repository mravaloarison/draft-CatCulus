class Bublle:
    ...
    def __init__(self, current_time, message_change_timer, message_change_interval, generated_quiz, count, index, quiz, font, instructions, WIDTH, HEIGHT, bubble_padding, bubble_height, new_quiz):
