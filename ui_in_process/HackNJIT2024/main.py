...
# background = pygame.image.load("Background Images/orangebackground.png").convert()
# background = pygame.transform.scale(background, (screen_width, screen_height))

# # Load the cat sprite sheet
# cat_sprite_sheet = pygame.image.load("4 Cat 2/Walk.png").convert_alpha()
...
# ghost_sprite_sheet = pygame.image.load("opponents/Bonus Character/Ghost_Walk.png").convert_alpha()

# # Define ghost sprite dimensions
# ghost_sprite_width, ghost_sprite_height = 48, 48  # Adjust based on actual frame size
# ghost_scale_factor = 2  # Scale factor for ghost
...
# ghost_death_sprite_sheet = pygame.image.load("opponents/Bonus Character/Ghost_Death.png").convert_alpha()

# # Define the dimensions for the death animation
# # (assuming each frame has the same dimensions as the walking frames)
...
# # Random messages for the speech bubble
# messages = [
#     "Quite the view up here!",
#     "Watch those airships!",
#     "Meow-velous machinery!",
#     "Steam power, how fascinating!",
#     "Time for an adventure!",
#     "These clockworks are purr-fect!",
#     "What a grand city!",
...
#     pygame.draw.rect(screen, (139, 69, 19), bubble_rect, 2, border_radius=15)
    
#     # Draw bubble pointer
#     pointer_points = [
#         (bubble_rect.centerx - 15, bubble_rect.bottom),
#         (bubble_rect.centerx + 15, bubble_rect.bottom),
#         (bubble_rect.centerx, bubble_rect.bottom + 15)
#     ]
#     pygame.draw.polygon(screen, (255, 255, 255, 230), pointer_points)
#     pygame.draw.polygon(screen, (139, 69, 19), pointer_points, 2)
